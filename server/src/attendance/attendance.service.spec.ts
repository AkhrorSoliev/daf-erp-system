...
describe('AttendanceService', () => {
  ...
  describe('save', () => {
    it('should save attendance and return success', async () => {
      ...
      expect(entityHistoryService.recordCreate).toHaveBeenCalledTimes(2);
    });
    ...
    it('should strip notes from teacher-only users', async () => {
      ...
      // The transaction was called - verify upsert args exclude note for Teacher
  ...
  describe('getStats', () => {
    it('should return attendance statistics per student', async () => {
      prisma.attendance.groupBy.mockResolvedValue([
