...
// ─── Link-based approval (no code re-entry) ───────────────────────────────
// App opens t.me/<bot>?start=req_<requestId>; the student taps START → bot
// approves the request (links it to their account); the app polls until approved.
