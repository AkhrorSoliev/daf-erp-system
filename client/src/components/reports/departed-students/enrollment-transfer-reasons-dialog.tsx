...
const QUERY_KEY = ["enrollment-transfer-reasons"] as const;
const API_PATH = "/enrollment-transfer-reasons";

export function EnrollmentTransferReasonsDialog({ open, onOpenChange }: Props) {
    ...
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Guruh almashtirish sabablari</DialogTitle>
            <DialogDescription>
              O&apos;quvchi bir guruhdan boshqasiga o&apos;tkazilganda
              ishlatiladigan sabablarni boshqaring
            </DialogDescription>
          </DialogHeader>
