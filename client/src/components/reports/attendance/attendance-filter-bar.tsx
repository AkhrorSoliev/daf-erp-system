...
export function resolveAttendanceRange(f: AttendanceFilter): {
  start: Date;
  end: Date;
  label: string;
} {
...
export function defaultAttendanceFilter(): AttendanceFilter {
  const now = new Date();
  return {
    branchId: null,
...
export function AttendanceFilterBar({ value, onChange }: Props) {
